...
<html>
	...
	<body style='background-color:#DFDFDF; font-family: Lora;'  >
		<div  style ='position:relative; top:450px; background-color:#EDEDED; text-align:center; line-height:auto; box-shadow: 5px 10px 10px #888888;' class="col-md-4 col-md-offset-4" > 
			<h1> Admin Login </h1>
